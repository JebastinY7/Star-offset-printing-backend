...
urlpatterns = [
    ...
    path('change-staff-password/<int:staff_id>/', views.settings, name='change_staff_password'),
    ...
    path("get-digital-laminations/", views.get_digital_laminations, name="get_digital_laminations"),
    ...
    path("live-search-quotations/", views.live_search_quotations, name="live_search_quotations"),
    path('quotation-bill/<int:id>/', views.quotation_bill, name='quotation_bill'),
